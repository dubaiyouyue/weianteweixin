...
class WeiSiteController extends BaseController {
    ...
    function lists() {
        ...
        $template_list = M('weisite_category')->where(array("id"=>intval($_REQUEST['cate_id'])))->find();//dump($template_list);
        $template_list_name = $template_list['template'];
        if ($template_list_name){
            $template_list_name = $template_list_name;
        } else{
            $template_list_name = 'lists';
        }
        ...
        $this->_footer();
        $this->display(ONETHINK_ADDON_PATH . 'WeiSite/View/default/TemplateLists/' . $this->config ['template_lists'] . '/'.$template_list_name .'.html');
    }
    ...
    function menu() {
        ...
        $this->_footer();
        $this->display(ONETHINK_ADDON_PATH . 'WeiSite/View/default/TemplateIndex/' . $this->config ['template_index'] . '/menu.html');
    }
